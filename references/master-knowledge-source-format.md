...
This format is used for extracting structured learning content from raw transcripts.

## Purpose

Transform unstructured, raw verbal data (transcripts, meeting notes, shadowing sessions) into structured, pedagogical learning assets that can be used to generate interactive websites, slide decks, and training manuals.

## Core Principles

1. **No Preamble/Postscript:** Output ONLY the structured content. No introduction, summary of what was done, or conclusion.
2. **Objectivity:** Remove all subjective conversational filler ("I think," "Maybe," "Let's try"). Convert into imperative, authoritative instructions.
